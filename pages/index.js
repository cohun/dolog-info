                  ...
                  <div className="tile is-parent is-vertical">
                    <article className="tile is-child notification is-warning">
                      ...
                      <div className="content has-text-black-dark">
                        NFC chip-el vagy QR kóddal beazonosított dolgok a rájuk
                        egyedileg jellemző információkat is hordozzák.
                      </div>
                    </article>
                    <article className="tile is-child notification is-warning">
                      <p className="title has-text-success-dark">
              ...
              <div className="tile is-parent">
                <article className="tile is-child notification has-background-black-ter">
                  ...
                  <div className="content has-text-warning">
                    ...
                    <div>
                      Általános nem időpobthoz kötött információk a jogosultság
                      függvényében szintén bármikor feltölthetőek.
                    </div>
                  </div>
                </article>
              </div>
